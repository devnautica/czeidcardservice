...
public class ScriptExecutor {
    ...
    public ScriptResponse execute(ScriptEnvelope env, IUIEntryProvider ep) {
        ...
        try {
            String s = "REQUEST:\n"+new ObjectMapper().writeValueAsString(script)+"\n\n";
            Files.write(Paths.get("/home/wenza/res_myfile.txt"), s.getBytes(), StandardOpenOption.APPEND);
        }catch (IOException e) {
        ...
        try {
            String s = env.getKeyId()+"|"+returnCode+"|\nRESPONSE:\n"+new ObjectMapper().writeValueAsString(blocks)+"\n\n\n\n";
